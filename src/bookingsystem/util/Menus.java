...
public class Menus {
    ...
    public void menuTram() {
        //debug
        BookingSystem.getLog().addEntry("Function: menuTram()");
    ...
    public void menuBus() {
        //debug
        BookingSystem.getLog().addEntry("Function: menuBus()");
    ...
    public void menuBoat() {
        //debug
        BookingSystem.getLog().addEntry("Function: menuBoat()");
    ...
    public void recipt() {
        //debug
        BookingSystem.getLog().addEntry("Function: recipt()");
